...
const { Transform, Readable, Writable, PassThrough, pipeline } = require('node:stream');
const { rejectIfError } = require('./promise');
const getCloneable = require('cloneable-readable');


// chains readable streams
const streamSequentially = (...streams) => Readable.from((async function* chainstream() {
